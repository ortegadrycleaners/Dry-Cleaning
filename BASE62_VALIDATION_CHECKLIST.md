...
5. Confirmar que en la pantalla de tracking se muestra la orden correcta.
6. Probar una URL invalida (ej. `/tracking/@@@`) y confirmar redireccion a `not-found`.
7. Confirmar que el backoffice sigue mostrando `orderNumber` legible como numero de ticket.
