...
export const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    'tracking.admin.badge': '🔒 Vista administrador',
    'tracking.admin.notesTitle': 'Notas de la orden',
    'tracking.admin.noNotes': 'Sin notas',
    ...
    'notifications.status.delivered': 'Entregado',
    'notifications.status.undelivered': 'No entregado',
    ...
    'dashboard.table.notesClickHint': 'click para ver todo',
    'dashboard.table.notesTapHint': 'toca para ver todo',
    ...
    'dashboard.sort.open': 'Abrir menú de ordenamiento',
    'dashboard.sort.label': 'Ordenar',
    'dashboard.sort.title': 'Ordenar órdenes por',
    'dashboard.sort.criteria': 'Criterio',
    'dashboard.sort.field.date': 'Fecha de orden',
    'dashboard.sort.field.orderNumber': 'Número de orden',
    'dashboard.sort.direction': 'Dirección',
    'dashboard.sort.direction.asc': 'Ascendente',
    'dashboard.sort.direction.desc': 'Descendente',
    ...
    'dashboard.dailyReport.description': 'Vista previa del listado de órdenes registradas en la fecha seleccionada',
    'dashboard.dailyReport.selectDate': 'Fecha del reporte:',
    'dashboard.dailyReport.todayButton': 'Hoy',
    'dashboard.dailyReport.businessName': 'Ortega Cleaners',
    'dashboard.dailyReport.docTitle': 'Control Diario de Órdenes',
    'dashboard.dailyReport.reportDate': 'Fecha del Reporte',
    'dashboard.dailyReport.emptyTitle': 'No hay órdenes registradas hoy',
    'dashboard.dailyReport.emptySubtitle': 'No se han creado nuevas órdenes en la fecha actual ({date}).',
    'dashboard.dailyReport.colTime': 'Hora',
    'dashboard.dailyReport.colOrder': 'Nro. Orden',
    'dashboard.dailyReport.colPhone': 'Teléfono del Cliente',
    'dashboard.dailyReport.colRack': 'Rack',
    'dashboard.dailyReport.colPieces': 'Piezas',
    'dashboard.dailyReport.totalLabel': 'Total de Órdenes Registradas Hoy:',
    'dashboard.dailyReport.printButton': 'Imprimir Reporte',
    'dashboard.dailyReport.loading': 'Obteniendo órdenes del día...',
    'dashboard.dailyReport.error': 'Ocurrió un error inesperado al generar el reporte.',
  ...
  en: {
    ...
    'tracking.admin.badge': '🔒 Admin view',
    'tracking.admin.notesTitle': 'Order notes',
    'tracking.admin.noNotes': 'No notes',
    ...
    'notifications.status.undelivered': 'Undelivered',
    ...
    'dashboard.table.notesClickHint': 'click to see all',
    'dashboard.table.notesTapHint': 'tap to see all',
    ...
    'dashboard.actions.deleteOrder': 'Delete order',
    'dashboard.deleteModal.title': 'Permanently Delete Order',
    'dashboard.deleteModal.warningTitle': 'Irreversible Warning!',
    'dashboard.deleteModal.warningDescription': 'This action will physically and permanently delete Order #{ticketLabel} for customer {customerName} in Supabase, including its reminder logs. Customer information will remain saved.',
    ...
    'dashboard.sort.open': 'Open sort menu',
    'dashboard.sort.label': 'Sort',
    'dashboard.sort.title': 'Sort orders by',
    'dashboard.sort.criteria': 'Criteria',
    'dashboard.sort.field.date': 'Order date',
    'dashboard.sort.field.orderNumber': 'Order number',
    'dashboard.sort.direction': 'Direction',
    ...
    'dashboard.dailyReport.buttonTitle': 'Print Daily Report',
    'dashboard.dailyReport.title': 'Daily Internal Control Report',
    'dashboard.dailyReport.description': 'Preview of orders registered on the selected date',
    'dashboard.dailyReport.selectDate': 'Report Date:',
    'dashboard.dailyReport.todayButton': 'Today',
    'dashboard.dailyReport.businessName': 'Ortega Cleaners',
    'dashboard.dailyReport.docTitle': 'Daily Order Control',
    'dashboard.dailyReport.reportDate': 'Report Date',
    'dashboard.dailyReport.emptyTitle': 'No orders registered today',
    'dashboard.dailyReport.emptySubtitle': 'No new orders created on current date ({date}).',
    'dashboard.dailyReport.colTime': 'Time',
    'dashboard.dailyReport.colOrder': 'Order #',
    'dashboard.dailyReport.colPhone': 'Customer Phone',
    'dashboard.dailyReport.colRack': 'Rack',
    'dashboard.dailyReport.colPieces': 'Pieces',
    'dashboard.dailyReport.totalLabel': 'Total Orders Registered Today:',
    'dashboard.dailyReport.printButton': 'Print Report',
    'dashboard.dailyReport.loading': 'Fetching today\'s orders...',
    'dashboard.dailyReport.error': 'An unexpected error occurred while generating the report.',
